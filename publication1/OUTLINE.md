> # ⚠ HISTORICAL PLANNING DOCUMENT — superseded 2026-08-04
>
> **This file records how the paper was planned (rev. 2), not what it became.** It is
> kept for the reasoning it preserves. Do not use it as a specification; the manuscript
> in this directory is the source of truth. Everything below predates rounds 1–4.
>
> **What is actually true now:**
>
> | | outline says | manuscript is |
> |---|---|---|
> | title | *…Benchmarking Reinforcement Learning against Classical…* | *Quadrotor Trajectory Tracking under Varying Payloads, Wind and Degraded Sensing: A Cross-Paradigm Controller Benchmark and Lessons Learnt* — the framing is no longer RL-versus-the-rest |
> | length | ~10 pages, "the binding constraint on every decision" | not a strict constraint; ≈14 pages at round 4 |
> | deployment result | three-way tie | **four-way** tie (offset-free MPC 0.057, DATT-Asym 0.059, ADRC+xadapt 0.060, ADRC 0.063) |
> | lessons | planned set | **seven**, three of which are self-corrections |
> | tables | separate nominal and disturbance tables | merged into one (Table 2); Table 3 is realistic sensing |
> | figures | a plan predating the figures | five exist, generated by `scripts/make_paper1_figures.py` |
>
> Current artifacts: `papers/paper1-benchmark/README.md` (claims → evidence → run
> directories), `reports/2026-08-*_p1-*.md` (round-by-round record).
