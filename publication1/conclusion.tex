...
claimed; yaw is held fixed throughout; and every number comes from a single airframe.
That last point bounds what generalizes and what does not. The error levels are
properties of a vehicle with a thrust-to-weight ratio of $1.88$ and a positioning system
updating at a few tens of hertz, and they would change on a larger platform. The
mechanisms behind them --- that beating a feedforward baseline under load requires
estimating the disturbance, that one observer bandwidth cannot serve two purposes, that
randomization produces averaging rather than adaptation in a memoryless policy, that
layered adaptation trades estimator observability for actuation invariance --- are
architectural, and the natural test of that reading is to repeat the protocol on a
platform with a wider authority margin and better sensing, where the same trade-offs
should appear compressed rather than absent. The hardware
